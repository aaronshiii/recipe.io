    ...
    $.getJSON(requestURL, function (recipe) {
      ...
      recipe.ingredientLines.forEach(function (ingredient) {
        $('#ingredient-list-table tbody').append(
          `<tr id="box">
            <td><input type="checkbox" class="remove" onchange="crossout('box')"></td>
...
//<td><button class="remove">x</button></td> if we want an x button instead

// remove ingredient when checked
